...
include("../MvcPart/app/controllers/db.php");
include("../MvcPart/app/controllers/functions.php");
...
<body>
    <header>
        <ul>
            <li>
                <a class="logo" href="./PaginaGeneralaClient.html">
            ...
            <li>
                <a class="header_button" href="./PaginaCalendarClientLogat.html">
                    <!-- <span class="header_icon"> <i class="fas fa-calendar-plus"></i> </span> -->
            ...
            <li>
                <a class="header_button" href="./PaginaFormularClient_intial.html">
            ...
            <li>
                <a class="header_button" href="./PaginaIstoric.html">
            ...
            <li>
                <a class="header_button">
                    ...
                    <span class="header_icon"> &#128100; </span>
                    <span class="header_text"><?php echo $user_data['user_name']; ?></span>
                </a>
                <ul class="header_button__login">
                    <li>
                        <a class="header_button" href="./PaginaResetPassClient.html">
                    ...
                    <li>
                        <a class="header_button" href="./index_client.html">
    ...
    <main>
        ...
        <!-- TO DO : adauga un mesaj de primire. si un link catre login -->
        <div class="client-welcome">
            ...
            <div class="client-welcome__mesaj">
                <p>Puteti sa faceti direct o programare <a href="./PaginaCalendarClientLogat.html">aici</a> </p>
                <p>Sau sa va creati intai un cont <a href="./PaginaSignupClient.html">aici</a> sau sa va autentificati
                    <a href="./PaginaLoginClient.html">aici</a>
                </p>
            </div>
